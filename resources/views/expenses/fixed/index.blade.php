        ...
        <table class="min-w-full text-sm">
            ...
            @forelse($costs as $cost)
                <tr class="border-t border-slate-100 dark:border-slate-800">
                    ...
                    <td class="px-4 py-3"><div class="responsive-actions flex justify-end gap-2"><x-action-link href="{{ route('expenses.fixed.edit', $cost) }}" icon="pencil-line" variant="edit">Tahrirlash</x-action-link><form action="{{ route('expenses.fixed.destroy', $cost) }}" method="POST">@csrf @method('DELETE')<x-delete-button /></form></div></td>
                </tr>
            @empty
