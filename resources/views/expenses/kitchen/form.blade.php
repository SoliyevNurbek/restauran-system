...
<div>
    ...
    <input name="gas_cost" type="number" step="0.01" min="0" value="{{ old('gas_cost', $cost?->gas_cost ?? 0) }}" class="w-full rounded-xl border border-slate-200 px-4 py-2.5 dark:border-slate-700 dark:bg-slate-800">
...
<div>
    ...
    <input name="electric_cost" type="number" step="0.01" min="0" value="{{ old('electric_cost', $cost?->electric_cost ?? 0) }}" class="w-full rounded-xl border border-slate-200 px-4 py-2.5 dark:border-slate-700 dark:bg-slate-800">
...
<div>
    ...
    <input name="salary_cost" type="number" step="0.01" min="0" value="{{ old('salary_cost', $cost?->salary_cost ?? 0) }}" class="w-full rounded-xl border border-slate-200 px-4 py-2.5 dark:border-slate-700 dark:bg-slate-800">
...
<div>
    ...
    <input name="tax_share" type="number" step="0.01" min="0" value="{{ old('tax_share', $cost?->tax_share ?? 0) }}" class="w-full rounded-xl border border-slate-200 px-4 py-2.5 dark:border-slate-700 dark:bg-slate-800">
